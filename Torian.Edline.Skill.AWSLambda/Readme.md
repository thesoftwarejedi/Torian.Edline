...
```
    cd "Torian.Edline.Skill.AWSLambda"
    dotnet restore
```

Execute unit tests
```
    cd "Torian.Edline.Skill.AWSLambda/test/Torian.Edline.Skill.AWSLambda.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "Torian.Edline.Skill.AWSLambda/src/Torian.Edline.Skill.AWSLambda"
